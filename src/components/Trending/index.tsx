      ...
      >
        {trending.map((movie) => (
          <img
            ...
            alt={movie.Title}
            className="min-w-[33.3333%] w-[33.3333%] sm:min-w-[25%] sm:w-[25%] md:min-w-[20%] md:w-[20%] lg:min-w-[16.6667%] lg:w-[16.6667%] xl:min-w-[14.2857%] xl:w-[14.2857%]  2xl:min-w-[12.5%] 2xl:w-[12.5%] aspect-[2/3] h-auto object-fill rounded-lg hover:scale-105 transition duration-300"
